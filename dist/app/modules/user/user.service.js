...
const updateUser = (userId, payload, decodedToken) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (payload.role) {
        if (decodedToken.role === user_interface_1.IUserRole.Receiver || decodedToken.role === user_interface_1.IUserRole.Sender) {
            throw new AppError_1.default(http_status_codes_1.default.FORBIDDEN, "You are not authorized");
        }
        if (payload.role === user_interface_1.IUserRole.Admin && decodedToken.role === user_interface_1.IUserRole.Admin) {
            throw new AppError_1.default(http_status_codes_1.default.FORBIDDEN, "You are not authorized");
        }
    }
    if (payload.password) {
        payload.password = yield bcrypt_1.default.hash(payload.password, env_1.envVars.BCRYPT_SALT_ROUND);
    }
